...
\begin{figure*}[h]
    ...
    \caption{Formatos de onda típicos em aplicações de estimulação elétrica (adaptado de  \cite{Robinson2002, Popovic2000}).}
    \label{fig:fon_f5}
\end{figure*}
