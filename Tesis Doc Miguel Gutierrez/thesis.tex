\documentclass[oneside,portuguese]{book}
...
\usepackage{float} % adicional para colocar in local
\usepackage[justification=centering]{caption} % para centrar tolos los caption
...
\titulolinhas{SISTEMA DE ELETROESTIMULAÇÃO COM DETECÇÃO DE FADIGA E TERAPIA AUTOMÁTICOS PARA EXERCÍCIOS DE FORTALECIMENTO}

\maketitle

%% No caso de haver outros autores (máximo 3), crie mais um "\autores"
\autores{MIGUEL EDUARDO GUTIERREZ PAREDES}
...
\datainfo{Dezembro}{15}{2018}

%% {Traduzido para outro língua}{Título original}
\titulolinguas{SISTEMA DE ELETROESTIMULAÇÃO COM DETECÇÃO DE FADIGA E TERAPIA AUTOMÁTICOS PARA EXERCÍCIOS DE FORTALECIMENTO}
...
\membrodabanca[Orientador]{Prof. Dr. Antônio Padilha Lanari Bó  \textendash{} ENE/UNB }

\membrodabanca[Membro Interno]{Prof. Dr. Adson Ferreira da Rocha \textendash{} ENE/UNB }

\membrodabanca[Membro Externo]{Prof. Dr. Márcio Nogueira de Souza  \textendash{} COPPE/UFRJ }

\membrodabanca[Membro Externo]{Prof. Dr. Vinícius Z. Maldaner da Silva  \textendash{} ESCS/SESDF }

\catalogonome[Gutierrez P., M. E.]{Gutierrez Paredes, Miguel Eduardo}

%% {Publicação N#}{Palavra chave #1}{chave #2}{chave #3}{chave #4}{n# páginas em romano}{n# páginas final}
\catalogoinfo{PPGEA.TD-001/11}{Eletroestimulador}{Limear motor}{Lesão medular}{Fadiga}{xi}{100}
...
\dedicatoriaautori{Dedico este trabalho aos meus pais Rigoberto e Luz Amparo е aos meus irmãos Claudia e Diego pois sem eles este trabalho e muitos dos meus sonhos não se realizariam. 
A minha namorada Andressa que com seu apoio incondicional e junto a sua família me acolheram e brindaram seu carinho.
A toda minha família que, com muito carinho е apoio, não mediram esforços para que eu chegasse até esta etapa da minha vida.”
A meus amigos е às pessoas com quem convivi nesses espaços ao longo desses anos. А experiência de uma produção compartilhada na comunhão com amigos nesses espaços foram uma das melhores experiências da minha formação acadêmica.}
% Texto segundo autor
...
\import{parts/}{capt_03}

\import{parts/}{capt_04}

\import{parts/}{capt_05}
