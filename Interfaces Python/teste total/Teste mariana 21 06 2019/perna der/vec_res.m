function [vector_resultante, sinal, tam_janela]= vec_res(data, plot_xyz, ac_fx)
...
if ac_fx == 1
    ...
    vector_resultante = data;
    sinal = ones(length(vector_resultante), 1) * max(vector_resultante);
    tam_janela = [0 0];
    if plot_xyz == 1
        figure();
        plot(vector_resultante);
